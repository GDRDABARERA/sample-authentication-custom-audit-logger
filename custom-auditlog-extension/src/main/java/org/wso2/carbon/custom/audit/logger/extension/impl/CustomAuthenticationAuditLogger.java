package org.wso2.carbon.custom.audit.logger.extension.impl;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.wso2.carbon.CarbonConstants;
import org.wso2.carbon.custom.audit.logger.extension.CustomAuditLoggerExtension;
...
/**
 * Custom implementation on Authentication audit.
 */
public class CustomAuthenticationAuditLogger extends CustomAuditLoggerExtension {
    ...
    public static final Log LOG = LogFactory.getLog(CustomAuthenticationAuditLogger.class);
    ...
    public void doPublishAuthenticationStepSuccess(AuthenticationData authenticationData) {
        ...
        String auditData = "\"" + "ContextIdentifier" + "\" : \"" + authenticationData.getContextId()
                ...
                + "\",\"" + "user-agent" + "\" : \"" + authenticationData.getParameter(USER_AGENT)
                + "\",\"" + "referer" + "\" : \"" + authenticationData.getParameter(REFERER)
                + "\",\"" + "cookie" + "\" : \"" + authenticationData.getParameter(COOKIE)
                + "\",\"" + "Host" + "\" : \"" + authenticationData.getParameter(HOST)
                + "\",\"" + "Client-ip" + "\" : \"" + authenticationData.getParameter(CLIENT_IP)
                + "\"";
    ...
    public void publishSessionTermination(HttpServletRequest request, AuthenticationContext context,
        ...
        String auditData = "\"" + "ContextIdentifier" + "\" : \"" + context.getContextIdentifier()
                ...
                + "\",\"" + "Client-ip" + "\" : \"" + getClientIpAddress(request)
                + "\"";
